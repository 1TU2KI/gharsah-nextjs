...
const ar = {
  ...
  cases: {
    ...
    sortLabel: "ترتيب حسب",
    sortOptions: {
      percentDesc: "نسبة الاكتمال من الأعلى إلى الأقل",
      percentAsc: "نسبة الاكتمال من الأقل إلى الأعلى",
      dateDesc: "تاريخ الإضافة — الأحدث أولاً",
      dateAsc: "تاريخ الإضافة — الأقدم أولاً",
    },
  },
  campaignCard: {
    status: {
  ...
  almostThere: {
    ...
    viewFullPage: "عرض اقتربت كاملة",
    emptyTitle: "لا توجد حالات قريبة من الاكتمال حاليًا",
    emptyMessage: "سيتم عرض الحالات هنا فور توفر بيانات نسبة الإنجاز لحالة نشطة.",
    copyPageLink: "نسخ رابط اقتربت",
    linkCopied: "تم نسخ الرابط",
    overlayCta: "استخدم أوفرلاي اقتربت في بثك ←",
  },
  news: {
    pageHeading: "الأخبار والتحديثات",
    pageDescription: "آخر التحديثات من غرسة — حالات جديدة، حالات اكتملت، وإعلانات مهمة.",
    homeHeading: "آخر التحديثات",
    homeDescription: "أهم ما جدّ في غرسة مؤخرًا.",
    viewAll: "عرض جميع التحديثات ←",
    emptyMessage: "لا توجد تحديثات حاليًا.",
    viewCampaign: "عرض الحالة",
  },
  randomCase: {
    ariaLabel: "اختيار حالة عشوائية",
    title: "دع غرسة تختار",
    description: "اختر عشوائيًا من بين الحالات النشطة، فكل مساهمةٍ تزرع أثرًا يبقى.",
    compactLabel: "دع غرسة تختار لك عشوائياً",
  },
  about: {
    heading: "عن غرسة",
    paragraphs: [
  ...
  contact: {
    ...
    campaignForm: {
      ...
      name: { label: "الاسم", helper: "اسم صاحب الصلة بالمستفيد", placeholder: "مثال: محمد" },
      username: {
        label: "اسم المستخدم",
        helper: "اسم المستخدم المعروف به داخل مجتمع البثوث.",
        placeholder: "مثال: Dev27",
      },
      relationship: {
        label: "نوع الصلة",
    ...
    otherForm: {
      heading: "تواصل معنا",
      subheading: "يرجى تزويدنا بالمعلومات التالية.",
      name: { label: "الاسم", helper: "الاسم الذي تود أن نتواصل معك به.", placeholder: "مثال: محمد" },
      email: {
...
const en = {
  ...
  cases: {
    ...
    sortLabel: "Sort by",
    sortOptions: {
      percentDesc: "Completion % — highest first",
      percentAsc: "Completion % — lowest first",
  ...
  almostThere: {
    ...
    viewFullPage: "View Full List",
    emptyTitle: "No campaigns are close to completion right now",
    emptyMessage: "Cases will appear here as soon as progress data is available for an active campaign.",
    copyPageLink: "Copy Almost There link",
    linkCopied: "Link copied",
    overlayCta: "Use the Almost There overlay on stream ←",
  },
  news: {
    pageHeading: "News & Updates",
    pageDescription: "The latest from Gharsah — new cases, completed campaigns, and important announcements.",
    homeHeading: "Latest Updates",
    homeDescription: "The latest happenings at Gharsah.",
  ...
  randomCase: {
    ...
    compactLabel: "Let Gharsah pick a campaign for you",
  },
  about: {
