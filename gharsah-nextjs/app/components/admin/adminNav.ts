...
export type AdminNavItem = {
  href: string;
  label: string;
  icon: "overview" | "campaigns" | "addCampaign" | "requests" | "messages" | "statistics" | "activity" | "settings" | "almostThere" | "overlay" | "news";
...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: `${ADMIN_BASE_PATH}/overlay`, label: "أوفرلاي البث", icon: "overlay", exact: true },
  { href: `${ADMIN_BASE_PATH}/news`, label: "الأخبار", icon: "news" },
